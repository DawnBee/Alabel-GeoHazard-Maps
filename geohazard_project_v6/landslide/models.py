from map_auxiliary.utils import LandslideFileRename, MapInfo
...
class Level(models.Model):
	...
	admin = models.ForeignKey(User,on_delete=models.PROTECT,verbose_name="Admin",related_name="landslide_levels")
...
class Markers(models.Model):
	...
	level = models.CharField(max_length=50,choices=LANDSLIDE_LEVELS, verbose_name="Risk Level")
	latitude = models.FloatField(null=False,blank=False)
	longitude = models.FloatField(null=False,blank=False)
	image = models.ImageField(default='default.jpg',upload_to='landslide_marker_imgs',blank=True)
...
class Choropleth(models.Model, LandslideFileRename, MapInfo):
	f = LandslideFileRename
	m = MapInfo

	id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
	admin = models.ForeignKey(User,on_delete=models.PROTECT,verbose_name="Admin",related_name="landslide_choropleths")
